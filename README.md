...
1. What is the DOM?
an object that represents the document
2. What is an event?
a piece of logic that will exicute based on a users action
3. What is an event listener?
the trip wire set up to see if the defined event/action has taken place
4. Why would we convert a NodeList into an Array?
To access array methods not availible on NodeLists like.map()
5. What is a component?
a function that creates a piece of HTML and can style it by applying different classes that correspond to CSS classes and ids
